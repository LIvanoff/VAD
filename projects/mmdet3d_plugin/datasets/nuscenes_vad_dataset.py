...
class VADCustomNuScenesDataset(NuScenesDataset):
    ...
    def evaluate(self,
        ...
        # for cls in motion_cls_names:
        #     # EPA
        #     gt_val = all_metric_dict.get('gt_'+cls, 0.0)
        #     result_dict['EPA_'+cls] = (all_metric_dict.get('hit_'+cls, 0.0) - 
        #                              alpha * all_metric_dict.get('fp_'+cls, 0.0)) / gt_val if gt_val != 0.0 else 0.0

        #     # ADE
        #     cnt_ade_val = all_metric_dict.get('cnt_ade_'+cls, 0.0)
        #     result_dict['ADE_'+cls] = all_metric_dict.get('ADE_'+cls, 0.0) / cnt_ade_val if cnt_ade_val != 0.0 else 0.0

        #     # FDE and MR (используют один и тот же знаменатель)
        #     cnt_fde_val = all_metric_dict.get('cnt_fde_'+cls, 0.0)
        #     if cnt_fde_val != 0.0:
        #         result_dict['FDE_'+cls] = all_metric_dict.get('FDE_'+cls, 0.0) / cnt_fde_val
        #         result_dict['MR_'+cls] = all_metric_dict.get('MR_'+cls, 0.0) / cnt_fde_val
        #     else:
