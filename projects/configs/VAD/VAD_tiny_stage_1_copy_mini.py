...
# total_epochs = 48
total_epochs = 12 # a short training
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'mini_vad_nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             pc_range=point_cloud_range,
             ann_file=data_root + 'mini_vad_nuscenes_infos_temporal_val.pkl',
...
log_config = dict(
    ...
    hooks=[
        ...
        #     init_kwargs=dict(
        #         project='VAD',   # Название проекта в WandB
        #         name='vad_tiny (nusc-min)',     # Имя эксперимента
